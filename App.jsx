...
export default function App() {
  ...
  const QUESTIONS = [
    ...
    },
    {
      id: 118,
      question:
        'The Radio Telex mode to be used when broadcasting a Distress Message, on 2174.5kHz, is:',
    ...
    },
    {
      id: 122,
      question:
        'The correct mode of emission for a RT distress message on 2182 kHz is',
    ...
    },
    {
      id: 123,
      question:
        'The correct class of emission for a MF Radiotelex transmission is',
    ...
    },
    {
      id: 125,
      question:
        'The Radio Telex mode to be used for one-to-one communications, with automatic error correction, is:',
    ...
    },
    {
      id: 197,
      question:
        'The abbreviation of telephony mode of radiation using phase modulation is',
    ...
    },
    {
      id: 198,
      question:
        'The abbreviation of telephony mode of radiation using amplitude modulation, SSB, suppressed carrier is',
    ...
    },
    {
      id: 199,
      question:
        'The abbreviation of telephony mode of radiation using amplitude modulation, SSB, full carrier is',
      answers: ['A3E', 'J3E', 'H3E', 'J2B'],
      correct: 2,
    },
    {
      id: 202,
      question:
        'Which type of transmission is used for transmitting ARQ and FEC from Ship Radio Station?',
    ...
    },
    {
      id: 203,
      question:
        'Which type of transmission is used for transmitting USB MF/HF call?',
    ...
    },
    {
      id: 376,
      question:
        'VHF-DSC transmissions are encoded and transmitted in what emission mode?',
        ...
        <div className="bg-zinc-900 p-10 rounded-2xl border border-zinc-700 max-w-2xl w-full text-center">
          ...
          <div className="text-2xl mb-8">
            ...
            <span className="text-red-400">
              {questionsToShow.length - correctAnswers}
            </span>
          </div>
        ...
        <div className="bg-zinc-900 border border-zinc-700 rounded-2xl p-8">
          ...
          <div className="grid gap-4">
            {question.answers.map((answer, index) => {
              ...
              let classes =
                'border border-zinc-700 hover:border-zinc-500 bg-zinc-800';
